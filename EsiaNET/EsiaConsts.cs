...
namespace EsiaNET
{
    ...
    public class EsiaConsts
    {
        ...
        public const string ErrorCertificateMustBeProvided = "ESIA Certificate must be provided";


        public const string ErrorParamMustBeProvided = "Value to '{0}' option must be provided";
