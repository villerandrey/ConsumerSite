...
using System.Text;
using System.Threading.Tasks;//using EsiaNET.Properties;
    ...
    public class EsiaClient
    {
        ...
        public EsiaClient(EsiaOptions options)
        {
            ...
            if ( String.IsNullOrWhiteSpace(Options.ClientId) )
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, EsiaConsts.ErrorCertificateMustBeProvided, "ClientId"));

            // Options.Scope must be provided
            if ( String.IsNullOrWhiteSpace(Options.Scope) )
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, EsiaConsts.ErrorParamMustBeProvided, "Scope"));

            // Options.RequestType must be provided
            if ( String.IsNullOrWhiteSpace(Options.RequestType) )
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, EsiaConsts.ErrorParamMustBeProvided, "RequestType"));

            // Options.SignProvider must be provided
            if ( Options.SignProvider == null )
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, EsiaConsts.ErrorParamMustBeProvided, "SignProvider"));
        }
        ...
        private string BuildClientSecret(string scope, string timestamp, string clientId, string state)
        {
            ...
            if ( certificate == null ) throw new ArgumentException(EsiaConsts.ErrorCertificateMustBeProvided);
