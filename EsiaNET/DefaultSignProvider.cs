...
namespace EsiaNET
{
    ...
    public class DefaultSignProvider : ISignProvider
    {
        ...
        public byte[] SignMessage(byte[] message, X509Certificate2 certificate)
        {
            ...
            var signedCms = new System.Security.Cryptography.Pkcs.EnvelopedCms(contentInfo);
            var cmsSigner = new System.Security.Cryptography.Pkcs.CmsRecipient (certificate);

            signedCms.Encrypt(cmsSigner);
